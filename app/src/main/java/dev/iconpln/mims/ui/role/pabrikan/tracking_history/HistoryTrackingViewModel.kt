...
import dev.iconpln.mims.data.remote.response.DetailHistoryTrackingResponse
...
@HiltViewModel
class HistoryTrackingViewModel @Inject constructor(private val apiService: ApiService) :
    ViewModel() {
    ...
    fun getHistoryTracking(pageIn: Int? = 1, pageSize: Int? = 100) {
